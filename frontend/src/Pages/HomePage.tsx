...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-full min-h-screen text-white">
      ...
      <h2 className="mb-4 text-center text-md md:text-2xl hover:text-yellow-300 transition duration-300">
        Explore a world of stories, knowledge, and imagination!</h2>

      <h4 className="mb-4 px-4 text-center text-sm md:text-lg font-semibold">
        Whoever finds solace [and delight] in [reading] books will never lack [any] solace. - Imam Ali (a.s) [Ghurar al-Hikam]
      </h4>
